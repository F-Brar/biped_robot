...
namespace MLAgents
{
    ...
    /// </summary>
    [System.Serializable]
    public class SteerRobotBodyPart
    {
        ...
        [HideInInspector] public SteerRobotJointDriveController thisRobotJDController;
        ...
        /// </summary>
        public void Reset(SteerRobotBodyPart bp)
        {
    ...
    public class SteerRobotJointDriveController : MonoBehaviour
    {
        ...
        [HideInInspector] public Dictionary<Transform, SteerRobotBodyPart> robotBodyPartsDict = new Dictionary<Transform, SteerRobotBodyPart>();

        [HideInInspector] public List<SteerRobotBodyPart> robotBodyPartsList = new List<SteerRobotBodyPart>();
        ...
        {
            SteerRobotBodyPart bp = new SteerRobotBodyPart
            {
