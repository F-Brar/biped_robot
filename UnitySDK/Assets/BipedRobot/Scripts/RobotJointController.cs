...
namespace MLAgents
{
    ...
    public class RobotJointDriveController : MonoBehaviour
    {
        ...
        [HideInInspector] public Dictionary<Transform, RobotBodyPart> bodyPartsDict = new Dictionary<Transform, RobotBodyPart>();

        [HideInInspector] public List<RobotBodyPart> bodyPartsList = new List<RobotBodyPart>();
